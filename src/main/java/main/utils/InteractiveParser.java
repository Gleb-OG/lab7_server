...
public class InteractiveParser {
    ...
    private static final Logger logger = LogManager.getLogger(InteractiveParser.class);
    ...
    public String readOrganizationName() {
        while (true) {
            try {
                ...
                logger.error("Завершение работы консоли.");
                System.exit(0);
            }
        }
    }
    ...
    public Organization parseOrganization() {
        ...
        return new Organization(name, coordinates, annualTurnover, type, address, "default");
    }
}